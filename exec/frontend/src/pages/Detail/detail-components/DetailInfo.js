  ...
  return (
    <div>
      ...
      <div style={{ padding: '5px 0 0 0' }}>
        <Typography className={styles.detail_right_info_popular}>이 제품의 인기 태그</Typography>
        <div>
          {propsGameInfo.tags.map((tag) => {
            return (
              <Button className={styles.tag} style={{ backgroundColor: data.lightVibrant }}>
                {tag}
              </Button>
            );
          })}
